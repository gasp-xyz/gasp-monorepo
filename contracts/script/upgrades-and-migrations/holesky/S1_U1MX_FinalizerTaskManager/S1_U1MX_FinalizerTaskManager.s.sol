...
contract Deployer is Script, Test, Utils {
    ...
    function _loadData() internal {
        ...
        require(1 == block.chainid, "You are on the wrong chain for this config");

        string memory avsDeploymentOutputPath = string.concat(vm.projectRoot(), "/script/output/1/avs_deployment_output.json");
