...
contract Deployer is Script, Utils, Test {
    ...
    IRolldownPrimitives.ChainId internal constant _CHAIN = IRolldownPrimitives.ChainId.Base;
    ...
    function _verifyInitalizations() internal view {
        ...
        require(gmrs.chainId() == _CHAIN, "gmrs.chainId() != chain");
        require(rolldown.chain() == _CHAIN, "rolldown.chain() != chain");
    }
