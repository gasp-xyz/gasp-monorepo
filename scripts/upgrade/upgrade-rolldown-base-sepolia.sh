...
PREFIX=wss://base-sepolia.gateway.tenderly.co/
...
ENV_SELECTOR=upgrade-rolldown-base-sepolia forge script script/MultiStage.s.sol --rpc-url $RPC_URL --account $WALLET_NAME -vvvvvvv
