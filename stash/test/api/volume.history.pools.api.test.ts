...
describe('API Errors: volume-history/pools', () => {
  it('GET pools/foo does not exist -> Expect validation error', async () => {
    const errorMessage =
      'this must be one of the following values: 0-1, 1-0, 3-1, 1-3, 3-0, 0-3, 0-2, 2-0, 7-5, 5-7, 1-7, 7-1, 4-5, 5-4, 3-4, 4-3, 1-5, 5-1, 4-0, 0-4, 7-0, 0-7, 1-4, 4-1, 0-5, 5-0, 5-3, 3-5, 1-15, 15-1, ALL'
    await supertest(app)
