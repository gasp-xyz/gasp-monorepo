...
describe.skip('APi tests: volume-history/pools', () => {
...
describe('API Errors: volume-history/pools', () => {
  it('GET pools/foo does not exist -> Expect validation error', async () => {
    const errorMessage =
      'this must be one of the following values: GASPV2-L1Asset, L1Asset-GASPV2, GASPV2-L1Asset-GASPV2, L1Asset-GASPV2-GASPV2, L1Asset-L1Asset-GASPV2, L1Asset-GASPV2-L1Asset, GASPV2-ETH-GASPV2, GASPV2-GASPV2-ETH, L1Asset-L1Asset, ALL'
    await supertest(app)
