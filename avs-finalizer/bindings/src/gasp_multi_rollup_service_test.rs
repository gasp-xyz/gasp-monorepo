...
pub mod gasp_multi_rollup_service_test {
    ...
    impl ::ethers::contract::EthLogDecode for GaspMultiRollupServiceTestEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = EigenUpdateProcessedFilter::decode_log(log) {
                return Ok(GaspMultiRollupServiceTestEvents::EigenUpdateProcessedFilter(decoded));
            }
    ...
    impl ::core::convert::From<EigenUpdateProcessedFilter> for GaspMultiRollupServiceTestEvents {
