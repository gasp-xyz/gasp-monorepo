...
pub mod finalizer_task_manager {
    ...
    pub enum FinalizerTaskManagerCalls {
        ...
        LastCompletedTaskQuorumThresholdPercentage(LastCompletedTaskQuorumThresholdPercentageCall),
    ...
    impl ::ethers::core::abi::AbiDecode for FinalizerTaskManagerCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <LastCompletedTaskCreatedBlockCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::LastCompletedTaskCreatedBlock(decoded));
            }
            if let Ok(decoded) =
                <LastCompletedTaskNumCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::LastCompletedTaskNum(decoded));
            }
            if let Ok(decoded) =
                <LastCompletedTaskQuorumNumbersCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::fmt::Display for FinalizerTaskManagerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::LastCompletedTaskNum(element) => ::core::fmt::Display::fmt(element, f),
                Self::LastCompletedTaskQuorumNumbers(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
                Self::LastCompletedTaskQuorumThresholdPercentage(element) => {
    ...
    impl ::core::convert::From<LastCompletedTaskCreatedBlockCall> for FinalizerTaskManagerCalls {
    ...
    impl ::core::convert::From<LastCompletedTaskQuorumNumbersCall> for FinalizerTaskManagerCalls {
