...
pub mod bls_public_key_compendium_mock {
    ...
    pub static BLSPUBLICKEYCOMPENDIUMMOCK_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static BLSPUBLICKEYCOMPENDIUMMOCK_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static BLSPUBLICKEYCOMPENDIUMMOCK_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    #[ethcall(
        ...
        abi = "registerPublicKey((uint256,uint256))"
    )]
    ...
    impl ::ethers::core::abi::AbiDecode for BLSPublicKeyCompendiumMockCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <RegisterPublicKeyCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for BLSPublicKeyCompendiumMockCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::RegisterPublicKey(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::convert::From<OperatorToPubkeyHashCall> for BLSPublicKeyCompendiumMockCalls {
        fn from(value: OperatorToPubkeyHashCall) -> Self {
            Self::OperatorToPubkeyHash(value)
        }
    }
    impl ::core::convert::From<PubkeyHashToOperatorCall> for BLSPublicKeyCompendiumMockCalls {
        fn from(value: PubkeyHashToOperatorCall) -> Self {
            Self::PubkeyHashToOperator(value)
        }
    }
    impl ::core::convert::From<RegisterBLSPublicKeyCall> for BLSPublicKeyCompendiumMockCalls {
        fn from(value: RegisterBLSPublicKeyCall) -> Self {
            Self::RegisterBLSPublicKey(value)
        }
    }
    impl ::core::convert::From<RegisterPublicKeyCall> for BLSPublicKeyCompendiumMockCalls {
