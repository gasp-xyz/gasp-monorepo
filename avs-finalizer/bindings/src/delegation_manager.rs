...
pub mod delegation_manager {
        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("setWithdrawalDelayBlocks",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::Param {
                            name: ::std::borrow::ToOwned::to_owned("newWithdrawalDelayBlocks",),
                            kind: ::ethers::core::abi::ethabi::ParamType::Uint(256usize,),
                            internal_type: ::core::option::Option::Some(
                                ::std::borrow::ToOwned::to_owned("uint256"),
                            ),
    ...
    impl ::ethers::contract::EthLogDecode for DelegationManagerEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = WithdrawalDelayBlocksSetFilter::decode_log(log) {
                return Ok(DelegationManagerEvents::WithdrawalDelayBlocksSetFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<WithdrawalDelayBlocksSetFilter> for DelegationManagerEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for DelegationManagerCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <SetWithdrawalDelayBlocksCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::fmt::Display for DelegationManagerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::SetWithdrawalDelayBlocks(element) => ::core::fmt::Display::fmt(element, f),
