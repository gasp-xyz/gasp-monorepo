...
impl<T: frame_system::Config> pallet_utility_mangata::WeightInfo for ModuleWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(Weight::from_parts(20_172_126, 0))
			// Standard Error: 2_496
			.saturating_add((Weight::from_parts(4_622_316, 0)).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		(Weight::from_parts(7_500_000, 0))
	}
	fn batch_all(c: u32, ) -> Weight {
		(Weight::from_parts(28_349_372, 0))
			// Standard Error: 2_569
			.saturating_add((Weight::from_parts(5_008_372, 0)).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		(Weight::from_parts(10_910_000, 0))
	}
	fn force_batch(c: u32, ) -> Weight {
		(Weight::from_parts(34_255_181, 0))
			// Standard Error: 3_663
			.saturating_add((Weight::from_parts(4_596_415, 0)).saturating_mul(c as u64))
	}
}
