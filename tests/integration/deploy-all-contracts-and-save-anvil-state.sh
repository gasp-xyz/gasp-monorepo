...
forge script script/M2_Deploy_From_Scratch.s.sol --rpc-url $RPC_URL --private-key $PRIVATE_KEY --broadcast -vvvvv --sig "run(string memory configFile)" -- M2_deploy_from_scratch.anvil.config.json
