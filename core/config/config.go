...
type ConfigRaw struct {
	...
	SubstrateWsRpcUrl    	   string              `yaml:"substrate_rpc_url"`
}
...
func NewConfig(ctx *cli.Context) (*Config, error) {
	...
	api, err := gsrpc.NewSubstrateAPI(configRaw.SubstrateWsRpcUrl)
	if err != nil {
		logger.Error("Cannot create substrate RPC", "url", configRaw.SubstrateWsRpcUrl, "err", err)
		return nil, err
	}
