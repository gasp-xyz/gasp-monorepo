...
pub mod slasher_mock {
        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("setCanWithdrawResponse",),
                        inputs: ::std::vec![::ethers::core::abi::ethabi::Param {
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("setOperatorFrozenStatus",),
                        inputs: ::std::vec![
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("operator"),
                                kind: ::ethers::core::abi::ethabi::ParamType::Address,
    ...
    pub static SLASHERMOCK_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static SLASHERMOCK_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static SLASHERMOCK_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> SlasherMock<M> {
        ...
        pub fn _can_withdraw(&self) -> ::ethers::contract::builders::ContractCall<M, bool> {
            self.0
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, SlasherMockEvents>
        {
            self.0
                .event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>> for SlasherMock<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for SlasherMockCalls {
        fn decode(
            ...
            if let Ok(decoded) = <_CanWithdrawCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
            ...
            if let Ok(decoded) =
                <SetCanWithdrawResponseCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
                return Ok(Self::SetCanWithdrawResponse(decoded));
            }
            if let Ok(decoded) =
                <SetOperatorFrozenStatusCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for SlasherMockCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::_CanWithdraw(element) => ::ethers::core::abi::AbiEncode::encode(element),
    ...
    impl ::core::fmt::Display for SlasherMockCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::SetCanWithdrawResponse(element) => ::core::fmt::Display::fmt(element, f),
                Self::SetOperatorFrozenStatus(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<ContractCanSlashOperatorUntilBlockCall> for SlasherMockCalls {
    ...
    impl ::core::convert::From<GetMiddlewareTimesIndexServeUntilBlockCall> for SlasherMockCalls {
        fn from(value: GetMiddlewareTimesIndexServeUntilBlockCall) -> Self {
            Self::GetMiddlewareTimesIndexServeUntilBlock(value)
        }
    }
    impl ::core::convert::From<GetMiddlewareTimesIndexStalestUpdateBlockCall> for SlasherMockCalls {
    ...
    impl ::core::convert::From<OperatorWhitelistedContractsLinkedListEntryCall> for SlasherMockCalls {
        fn from(value: OperatorWhitelistedContractsLinkedListEntryCall) -> Self {
            Self::OperatorWhitelistedContractsLinkedListEntry(value)
        }
    }
    impl ::core::convert::From<OperatorWhitelistedContractsLinkedListSizeCall> for SlasherMockCalls {
    ...
    impl ::core::convert::From<RecordLastStakeUpdateAndRevokeSlashingAbilityCall> for SlasherMockCalls {
