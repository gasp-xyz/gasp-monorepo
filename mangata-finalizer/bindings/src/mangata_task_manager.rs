...
pub mod mangata_task_manager {
    ...
    pub static MANGATATASKMANAGER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    pub static MANGATATASKMANAGER_BYTECODE: ::ethers::core::types::Bytes =
    ...
    pub static MANGATATASKMANAGER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> MangataTaskManager<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, MangataTaskManagerEvents>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for MangataTaskManagerEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(MangataTaskManagerEvents::OwnershipTransferredFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = TaskChallengedSuccessfullyFilter::decode_log(log) {
                return Ok(MangataTaskManagerEvents::TaskChallengedSuccessfullyFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = TaskChallengedUnsuccessfullyFilter::decode_log(log) {
                return Ok(MangataTaskManagerEvents::TaskChallengedUnsuccessfullyFilter(decoded));
            }
    ...
    impl ::core::convert::From<TaskChallengedSuccessfullyFilter> for MangataTaskManagerEvents {
        fn from(value: TaskChallengedSuccessfullyFilter) -> Self {
            Self::TaskChallengedSuccessfullyFilter(value)
        }
    }
    impl ::core::convert::From<TaskChallengedUnsuccessfullyFilter> for MangataTaskManagerEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for MangataTaskManagerCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <GetTaskChallangeWindowBlockCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::fmt::Display for MangataTaskManagerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::GetTaskChallangeWindowBlock(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<TaskChallengeWindowBlockCall> for MangataTaskManagerCalls {
    ...
    impl ::core::convert::From<GetCheckSignaturesIndicesCall> for MangataTaskManagerCalls {
    ...
    impl ::core::convert::From<GetTaskChallangeWindowBlockCall> for MangataTaskManagerCalls {
        fn from(value: GetTaskChallangeWindowBlockCall) -> Self {
            Self::GetTaskChallangeWindowBlock(value)
        }
    }
    impl ::core::convert::From<GetTaskResponseWindowBlockCall> for MangataTaskManagerCalls {
    ...
    impl ::core::convert::From<RaiseAndResolveChallengeCall> for MangataTaskManagerCalls {
    ...
    impl ::core::convert::From<TaskSuccesfullyChallengedCall> for MangataTaskManagerCalls {
    ...
    impl ::core::convert::From<TrySignatureAndApkVerificationCall> for MangataTaskManagerCalls {
