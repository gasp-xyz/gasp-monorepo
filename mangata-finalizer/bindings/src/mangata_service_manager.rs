...
pub mod mangata_service_manager {
        ...
        ::ethers::core::abi::ethabi::Contract {
            constructor: ::core::option::Option::Some(::ethers::core::abi::ethabi::Constructor {
                inputs: ::std::vec![
                    ...
                    ::ethers::core::abi::ethabi::Param {
                        ...
                        kind: ::ethers::core::abi::ethabi::ParamType::Address,
                        internal_type: ::core::option::Option::Some(
                            ::std::borrow::ToOwned::to_owned("contract IMangataTaskManager",),
                        ),
                    },
                ],
            }),
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        ...
                        inputs: ::std::vec![
                            ...
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("referenceBlockNumber",),
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("trySignatureAndApkVerification",),
                        inputs: ::std::vec![
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::borrow::ToOwned::to_owned("msgHash"),
                                kind: ::ethers::core::abi::ethabi::ParamType::FixedBytes(32usize,),
    ...
    pub static MANGATASERVICEMANAGER_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes =
    ...
    impl<M: ::ethers::providers::Middleware> MangataServiceManager<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, MangataServiceManagerEvents>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for MangataServiceManagerEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(MangataServiceManagerEvents::OwnershipTransferredFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = PauserRegistrySetFilter::decode_log(log) {
                return Ok(MangataServiceManagerEvents::PauserRegistrySetFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<OwnershipTransferredFilter> for MangataServiceManagerEvents {
    ...
    impl ::core::convert::From<TrySignatureAndApkVerificationCall> for MangataServiceManagerCalls {
