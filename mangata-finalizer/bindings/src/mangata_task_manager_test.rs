...
pub mod mangata_task_manager_test {
    ...
    impl ::ethers::contract::EthLogDecode for MangataTaskManagerTestEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(
                    MangataTaskManagerTestEvents::LogNamedDecimalIntFilter(decoded),
                );
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(
                    MangataTaskManagerTestEvents::LogNamedDecimalUintFilter(decoded),
                );
            }
    ...
    for MangataTaskManagerTestEvents {
    ...
    for MangataTaskManagerTestCalls {
