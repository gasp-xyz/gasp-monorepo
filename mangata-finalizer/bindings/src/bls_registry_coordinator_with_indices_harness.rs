...
pub mod bls_registry_coordinator_with_indices_harness {
    ...
    pub static BLSREGISTRYCOORDINATORWITHINDICESHARNESS_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static BLSREGISTRYCOORDINATORWITHINDICESHARNESS_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    pub struct BLSRegistryCoordinatorWithIndicesHarness<M>(
    ...
    > BLSRegistryCoordinatorWithIndicesHarness<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                BLSREGISTRYCOORDINATORWITHINDICESHARNESS_ABI.clone(),
                BLSREGISTRYCOORDINATORWITHINDICESHARNESS_BYTECODE.clone().into(),
                client,
            );
    ...
    for BLSRegistryCoordinatorWithIndicesHarnessEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = EjectorUpdatedFilter::decode_log(log) {
                return Ok(
                    BLSRegistryCoordinatorWithIndicesHarnessEvents::EjectorUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(
                    BLSRegistryCoordinatorWithIndicesHarnessEvents::InitializedFilter(
                        decoded,
                    ),
                );
            }
            ...
            if let Ok(decoded) = PausedFilter::decode_log(log) {
                return Ok(
                    BLSRegistryCoordinatorWithIndicesHarnessEvents::PausedFilter(decoded),
                );
            }
            ...
            if let Ok(decoded) = UnpausedFilter::decode_log(log) {
                return Ok(
                    BLSRegistryCoordinatorWithIndicesHarnessEvents::UnpausedFilter(
                        decoded,
                    ),
                );
            }
    ...
    for BLSRegistryCoordinatorWithIndicesHarnessCalls {
        fn decode(
            ...
            if let Ok(decoded) = <RecordOperatorQuorumBitmapUpdateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::core::convert::From<EjectorCall>
    for BLSRegistryCoordinatorWithIndicesHarnessCalls {
    ...
    impl ::core::convert::From<PauseCall>
    for BLSRegistryCoordinatorWithIndicesHarnessCalls {
        fn from(value: PauseCall) -> Self {
            Self::Pause(value)
        }
    }
    impl ::core::convert::From<PauseAllCall>
    for BLSRegistryCoordinatorWithIndicesHarnessCalls {
    ...
    impl ::core::convert::From<SetOperatorIdCall>
    for BLSRegistryCoordinatorWithIndicesHarnessCalls {
    ...
    impl ::core::convert::From<SlasherCall>
    for BLSRegistryCoordinatorWithIndicesHarnessCalls {
