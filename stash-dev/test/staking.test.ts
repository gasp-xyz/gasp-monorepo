...
import { DailyRewardResponse, ResponseAPY, Session } from '../src/repository/StakingRepository'
...
describe('[Staking]', () => {
  beforeAll(() => {
    vi.mock('../src/repository/StakingRepository', async () => {
      ...
      return {
        ...actual,
        getDataByAddress: vi.fn().mockImplementation((collatorAddress: string) => {
            ...
            const sessions: Session[] = [
              {
                ...
                data: {
                  ...
                  method: 'Rewarded',
                  sessionIndex: 2490,
                  collatorAccount: '5ChaosDANFE2q4qH3UnCUJ5ZXHms5TWwsbrx4YXNrwQh2nfk',
                  ...
                  collatorAccountAmountStakedInMgx: '10552849521963136690759768',
              ...
              },
              {
                ...
                data: {
                  ...
                  collatorAccountAmountStakedInLp: '3247617765048459965147037',
                  collatorAccountAmountStakedInMgx: '10553347397938914387586940',
              ...
              },
              {
                ...
                data: {
                  ...
                  liquidityTokenReserve: '153296294582212172810103656',
                  collatorAccountAmountStakedInLp: '3247617765048459965147037',
                  collatorAccountAmountStakedInMgx: '10547708317787712454837064',
  ...
  it('should mock the apy endpoint method', async () => {
    ...
    const results = await apy('5ChaosDANFE2q4qH3UnCUJ5ZXHms5TWwsbrx4YXNrwQh2nfk')
  ...
  it('should mock the daily rewards endpoint method', async () => {
    ...
    const results = await dailyRewards('5ChaosDANFE2q4qH3UnCUJ5ZXHms5TWwsbrx4YXNrwQh2nfk', undefined)
    expect(results).deep.equal(expectedResponse)
  })
})
