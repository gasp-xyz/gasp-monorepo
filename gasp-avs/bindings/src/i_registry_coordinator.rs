...
pub mod i_registry_coordinator {
    ...
    pub static IREGISTRYCOORDINATOR_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> IRegistryCoordinator<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IRegistryCoordinatorEvents>
        {
            self.0
    ...
    impl ::ethers::contract::EthLogDecode for IRegistryCoordinatorEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = ChurnApproverUpdatedFilter::decode_log(log) {
                return Ok(IRegistryCoordinatorEvents::ChurnApproverUpdatedFilter(
                    decoded,
                ));
            }
            ...
            if let Ok(decoded) = OperatorDeregisteredFilter::decode_log(log) {
                return Ok(IRegistryCoordinatorEvents::OperatorDeregisteredFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = OperatorRegisteredFilter::decode_log(log) {
                return Ok(IRegistryCoordinatorEvents::OperatorRegisteredFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = OperatorSetParamsUpdatedFilter::decode_log(log) {
                return Ok(IRegistryCoordinatorEvents::OperatorSetParamsUpdatedFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = QuorumBlockNumberUpdatedFilter::decode_log(log) {
                return Ok(IRegistryCoordinatorEvents::QuorumBlockNumberUpdatedFilter(
                    decoded,
                ));
            }
    ...
    impl ::core::convert::From<ChurnApproverUpdatedFilter> for IRegistryCoordinatorEvents {
    ...
    impl ::core::convert::From<OperatorDeregisteredFilter> for IRegistryCoordinatorEvents {
    ...
    impl ::core::convert::From<OperatorSetParamsUpdatedFilter> for IRegistryCoordinatorEvents {
        fn from(value: OperatorSetParamsUpdatedFilter) -> Self {
            Self::OperatorSetParamsUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<QuorumBlockNumberUpdatedFilter> for IRegistryCoordinatorEvents {
    ...
    impl ::core::convert::From<GetCurrentQuorumBitmapCall> for IRegistryCoordinatorCalls {
    ...
    impl ::core::convert::From<GetQuorumBitmapAtBlockNumberByIndexCall> for IRegistryCoordinatorCalls {
        fn from(value: GetQuorumBitmapAtBlockNumberByIndexCall) -> Self {
            Self::GetQuorumBitmapAtBlockNumberByIndex(value)
        }
    }
    impl ::core::convert::From<GetQuorumBitmapHistoryLengthCall> for IRegistryCoordinatorCalls {
        fn from(value: GetQuorumBitmapHistoryLengthCall) -> Self {
            Self::GetQuorumBitmapHistoryLength(value)
        }
    }
    impl ::core::convert::From<GetQuorumBitmapIndicesAtBlockNumberCall> for IRegistryCoordinatorCalls {
        fn from(value: GetQuorumBitmapIndicesAtBlockNumberCall) -> Self {
            Self::GetQuorumBitmapIndicesAtBlockNumber(value)
        }
    }
    impl ::core::convert::From<GetQuorumBitmapUpdateByIndexCall> for IRegistryCoordinatorCalls {
    ...
    impl ::core::convert::From<PubkeyRegistrationMessageHashCall> for IRegistryCoordinatorCalls {
    ...
    impl ::core::convert::From<QuorumUpdateBlockNumberCall> for IRegistryCoordinatorCalls {
